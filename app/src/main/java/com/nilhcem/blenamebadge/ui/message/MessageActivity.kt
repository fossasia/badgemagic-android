   ...
   // private val marquee: CheckBox by bindView(R.id.marquee)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        send.setOnClickListener {
            ...
            val hideSoftInputFromWindow = inputManager.hideSoftInputFromWindow(content.windowToken, InputMethodManager.SHOW_FORCED)
            // Easter egg
    ...
    private fun convertToDeviceDataModel(): DataToSend {
        return DataToSend(listOf(Message(content.text.trim().toString(), false, true, Speed.values()[speed.selectedItemPosition], Mode.values()[mode.selectedItemPosition])))
    }
